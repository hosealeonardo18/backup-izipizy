...
const Profile = () => {
  ...
  const getOwnProduct = () => {
    ...
    axios
      .get(`https://izipizy-team.up.railway.app/api/v1/recipe/myrecipe`, {
        headers: {
  ...
  const getSavedProduct = () => {
    const token = localStorage.getItem('token');
    axios
      .get(`https://izipizy-team.up.railway.app/api/v1/saved/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const getLikedProduct = () => {
    const token = localStorage.getItem('token');
    axios
      .get(`https://izipizy-team.up.railway.app/api/v1/liked/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  useEffect(() => {
    axios
      .get(`https://izipizy-team.up.railway.app/api/v1/user/profile`, {
        headers: {
  ...
  const onUpdateusers = (e) => {
    ...
    axios
      .put(`https://izipizy-team.up.railway.app/api/v1/user/edit/${profile.id}`, formDatas, {
        headers: {
  ...
  const getDetailProduct = (id) => {
    axios
      .get(`https://izipizy-team.up.railway.app/api/v1/recipe/${id}`)
      .then((res) => {
        console.log(res.data.data);
