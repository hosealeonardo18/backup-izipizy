...
const DetailRecipe = () => {
  ...
  const handleSave = () => {
    if (!saveActive) {
      setSaveActive(true);
      axios
        .post(`https://izipizy-team.up.railway.app/api/v1/saved`, save, {
          headers: {
  ...
  const handleLike = () => {
    if (!likeActive) {
      setLikeActive(true);
      axios
        .post(`https://izipizy-team.up.railway.app/api/v1/liked`, likes, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
  ...
  const handleSendComment = (e) => {
    ...
    axios
      .post(`https://izipizy-team.up.railway.app/api/v1/comment`, comments, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
